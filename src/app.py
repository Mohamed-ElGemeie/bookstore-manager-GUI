...
class App(tk.Tk):
  ...
  def __init__(self,*args,**kwargs):
    ...
    pages = (PrintPage,TakeawayPage,SessionPage,AnalysisPage)
    page_names = ("Books/كتب","Takeaway/تيك اواى","Tables/طاولات","Report/جرد")
    self.frames = {}
    self.buttons = {}
    ...
    self.show_frame(AnalysisPage.__name__)
